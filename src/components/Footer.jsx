...
const Footer = () => {
  //I love the structure and organization of this. So clean and the use of arrays and objects blends in so well
  return (
    ...
    flex-col`}>
      <div className={`${styles.flexStart} md:flex-row
        ...
        <div className="flex-1 flex flex-col justify-start mr-10">
          ...
          src={logo} 
          alt="hoobank"
          className="w-66.5 h-18 object-contain"
          />
          <p className={`${styles.paragraph} mt-4 max-w-77.5`}>
            ...
            ss:my-0 my-4 min-w-37.5">
              ...
              <ul className="list-none mt-4">
                {footerLink.links.map((link, index) => (
                  ...
                  leading-6 text-dimWhite hover:text-secondary
      ...
      items-center md:flex-row flex-col pt-6 border-t
      border-t-[#3F3E45]">
        ...
        <div className="flex flex-row md:mt-0 mt-6">
          {socialMedia.map((social, index) => (
            <img
              ...
              src={social.icon}
              alt={social.id}
              className={`w-5.25 h-5.25 object-contain cursor-pointer
